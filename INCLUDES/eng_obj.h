...
/* les flags sont les mêmes que pour le germe, voir ci-dessus */
#define AZT_Flags               (AZT_OBJ|0x0000)
#define AZT_UserData            (AZT_OBJ|0x0001)
#define AZT_CmdLine             (AZT_OBJ|0x0002)
#define AZT_ExtraBuf            (AZT_OBJ|0x0003)
#define AZT_ExeFrom             (AZT_OBJ|0x0004)
